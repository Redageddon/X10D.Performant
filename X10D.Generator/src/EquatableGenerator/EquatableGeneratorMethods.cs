...
{
    private const string StartingChunk = @"namespace X10D.Performant.IEquatableExtensions
{
...
";
    ...
    private static string GetClass(string type, string binarySeparationType, bool isReversedType, int argsCount)
    {
        ...
        classBuilder.Append("/*");
        classBuilder.AppendLine(Program.AutoGeneratedString1);
        classBuilder.Append(Program.AutoGeneratedString2);
        classBuilder.Append("*/");
