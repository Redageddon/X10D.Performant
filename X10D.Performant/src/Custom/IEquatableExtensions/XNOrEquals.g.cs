...
namespace X10D.Performant.IEquatableExtensions
{
    public static partial class EquatableExtensions
    {
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals5"]'/>
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals6"]'/>
        public static bool XNOrEquals<T>(this T value, T arg1, T arg2, T arg3, T arg4, T arg5, T arg6)
            where T : IEquatable<T> =>
            !(!(!(!(!(value.Equals(arg1) ^ value.Equals(arg2)) ^ value.Equals(arg3)) ^ value.Equals(arg4)) ^ value.Equals(arg5))
            ^ value.Equals(arg6));

        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals7"]'/>
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals8"]'/>
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals9"]'/>
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals10"]'/>
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals11"]'/>
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals12"]'/>
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals13"]'/>
        public static bool XNOrEquals<T>(this T value,
                                         T arg1,
                                         T arg2,
                                         T arg3,
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals14"]'/>
        public static bool XNOrEquals<T>(this T value,
                                         T arg1,
                                         T arg2,
                                         T arg3,
        ...
        /// <include file='EquatableExtensions.xml' path='members/member[@name="XNOrEquals15"]'/>
        public static bool XNOrEquals<T>(this T value,
                                         T arg1,
                                         T arg2,
                                         T arg3,
