...
{
    /// <include file='UInt16Extensions.g.xml' path='members/member[@name="IsEven"]'/>
    public static bool IsEven(this ushort value) => (value & 1) == 0;

    /// <include file='UInt16Extensions.g.xml' path='members/member[@name="IsOdd"]'/>
    public static bool IsOdd(this ushort value) => (value & 1) == 1;

    /// <include file='UInt16Extensions.g.xml' path='members/member[@name="ToBoolean"]'/>
