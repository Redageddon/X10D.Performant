...
namespace X10D.Performant.CharExtensions
{
    ...
    {
        /// <inheritdoc cref="System.Decimal.Parse(ReadOnlySpan{char},NumberStyles,IFormatProvider)"/>
        ...
        /// <inheritdoc cref="System.Decimal.TryParse(ReadOnlySpan{char},out decimal)"/>
