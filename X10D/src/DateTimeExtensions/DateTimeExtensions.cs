...
namespace X10D.Performant.DateTimeExtensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <returns>Returns an <see cref="int"/> representing the number of years since <paramref name="date"/> as of <paramref name="asOf"/>.</returns>
        ...
        /// <returns>Returns a <see cref="DateTime"/> representing the first occurence of <paramref name="dayOfWeek"/>.</returns>
        ...
        /// <returns>Returns a <see cref="DateTime"/> representing the first day of the month>.</returns>
        ...
        /// <param name="current">The current date.</param>
        /// <param name="dayOfWeek">The current day of week.</param>
        /// <returns>Returns a <see cref="DateTime"/> representing the final occurence of <paramref name="dayOfWeek"/>.</returns>
        ...
        /// </summary>
        /// <param name="current">The current date.</param>
        /// <returns>Returns a <see cref="DateTime"/> representing the last day of the month>.</returns>
        ...
        /// <returns>Returns a <see cref="DateTime"/> representing the next occurence of <paramref name="dayOfWeek"/>.</returns>
        ...
        /// </param>
        /// <returns>Returns a <see cref="long"/> in terms of a Unix timestamp representing the provided <see cref="DateTime"/>.</returns>
